...
namespace TMS.Database.Entities
{
    ...
    {
        private readonly IDatabaseContextFactory<TEntity> _contextFactory;
        private readonly IEntityBuilder<TData, TEntity> _entityBuilder;

        public EntityService(IDatabaseContextFactory<TEntity> context,
        ...
        public TEntity Save<TKey>(TData data, Func<TKey, DbSet<TEntity>, TEntity> entityFinder) where TKey : class, IModelKey
        {
            TEntity entity;
        ...
        public TEntity UpdateAndSave<TKey>(TData data, TKey key, Func<TKey, DbSet<TEntity>, TEntity> entityFinder) where TKey : class, IModelKey
        {
