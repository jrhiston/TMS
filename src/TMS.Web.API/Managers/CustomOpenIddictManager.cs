...
namespace TMS.Web.API.Managers
{
    public class CustomOpenIddictManager : OpenIddictUserManager<ApplicationUser>
    {
        public CustomOpenIddictManager(IServiceProvider services, 
            ...
            ILookupNormalizer 
            keyNormalizer, 
            IdentityErrorDescriber errors) : base(services, store, options, logger, hasher, userValidators, passwordValidators, keyNormalizer, errors)
        {
        }
